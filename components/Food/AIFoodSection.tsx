// components/Food/AIFoodSection.tsx
...
interface AIFoodSectionProps extends BaseComponentProps {
  onUploadPhoto: () => void;
  onTakePhoto: () => void;
}

const AIFoodSection: React.FC<AIFoodSectionProps> = ({ 
  onUploadPhoto, 
  onTakePhoto,
  style 
}) => {
